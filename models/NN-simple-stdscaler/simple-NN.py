...
if __name__=="__main__":
    ...
    if len(sys.argv)>1 and sys.argv[1]=="run_node":
        ...
        fig1.write_image(file_name+"_large.png", width=1600, height=1100,scale=4)
        fig1.write_image(file_name+"_med.png", width=1200, height=800,scale=4)
        fig1.write_image(file_name+"_med2.png", width=1400, height=950,scale=4)
        fig1.write_image(file_name+"_small.png", width=1000, height=700,scale=4)

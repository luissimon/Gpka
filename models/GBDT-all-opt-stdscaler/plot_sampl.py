...
if __name__=="__main__":
    ...
    for lot in levels_of_theory:
        ...
        """
        prepare_eq_data(file_name=test_csv_file,drop_compounds=drop_compounds,test_size=0.0,correlated_groups=correlated_groups,standarize=False,train_suffix="_all.csv")
        ...
        prepare_graph_data_to_ML(json_file=test_json_file,csv_file_name=test_csv_file,correlated_groups=correlated_groups,
                                ...
                                standarize=True,use_standard_scalers="g_standard_scalers.txt",std_transformer="StandardScaler")
        """
        ...
        composed_regressor_params={
            ...
            'lxalpha': 0.2568484324204346, 'lxl1_ratio': 1.7103982517155383, 'nl_bootstrap': False, 'nl_max_features': 0.5544257839350846, 'nl_booster': 'gbtree', 'nl_max_depth': 6, 'nl_subsample': 0.5609777841019409, 'nl_gamma': 0.0036326761011042418, 'nl_reg_lambda': 1.06421799794472, 'nl_reg_alpha': 1.5334098326457903, 'nl_tree_method': 'hist', 'nl_refresh_leaf': False, 'nl_max_bin': 206, 'nl_eta': 0.2478014105328064, 'nl_inner_n_estimators': 170, 'nl_n_estimators': 14,

...
if __name__=="__main__":
    ...
    for lot in levels_of_theory:
        ...
        #std_scalers=prepare_graph_data_to_ML(json_file=train_json_file,csv_file_name=train_csv_file,correlated_groups=correlated_groups,test_suffix="",train_suffix="_all.csv",prepare_test_set=False,return_standard_scalers=True) 
        #prepare_graph_data_to_ML(json_file=test_json_file,csv_file_name=test_csv_file,correlated_groups=correlated_groups,test_suffix="",train_suffix="_all.csv",prepare_test_set=False,use_standard_scalers=std_scalers) 

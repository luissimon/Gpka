...
class composed_regressor(sklearn.base.BaseEstimator):
    ...
    def set_params(self,**kwargs):
        """
        set_params must be declared for using sklearn crossvalidation and other model optimization tools.
        It is also called by the construction of the class composed_regressor.
    ...
    def __init__(self,**kwargs):
        ...
        use_shap : wether to use or not shap for calculating feature importances. shap is not available for "AdaBoostRegressor"
        ...
        elif self.non_linear_regressor_name==  "LGBMRegressor":             self.non_lin_reg=lightgbm.LGBMRegressor()
        elif self.non_linear_regressor_name==  "BaggingRegressor-LGBM":     self.non_lin_reg=myBaggingRegressor(lightgbm.LGBMRegressor())
    ...
    def fit(self,X_train,y_train,sample_weight=None,early_stopping_rounds=10):
        ...
        if self.linear_regressor_name not in ["LinearRegression","RANSACRegressor","ElasticNet"] and self.lin_reg.n_iter_==self.lin_reg.get_params()["max_iter"]:

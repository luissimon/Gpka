...
def xyz2AC(atoms, xyz, charge, use_huckel=False,covalent_factor=1.3):
    """
...
def xyz2AC_vdW(atoms, xyz,covalent_factor=1.3):
    ...
    AC = get_AC(mol,covalent_factor=covalent_factor)
...
def xyz2mol(atoms, coordinates, charge=0, allow_charged_fragments=True,
            ...
            use_atom_maps=False, covalent_factor=1.3):
    """
    ...
    AC, mol = xyz2AC(atoms, coordinates, charge, use_huckel=use_huckel,covalent_factor=covalent_factor)

...
def prepare_optimization(file_name,n_procs=14):
    ...
    opt_orca_txt='! PBEh-3c CPCM defgrid1 CHELPG Hirshfeld \n  %cpcm smd true\n  SMDsolvent "water"  end\n  \n   \n   MaxStep 0.3  \n end\n'
...
def run_optimization(file_name, n_procs=14, orca_exe="/home/orca5/orca",scratch_home="/scratch/lsimon/",old_files_folder="/home/lsimon/jobs/pka/output_files/optmization/"):
    charge,compound_name=get_charge(file_name)

#! /usr/bin/env python3
# -*- coding: utf-8 -*-
# script to get inchi and inchikey from structures. It creates a new csv file with the inchi, inchi keys, smiles and smarts added, using the xyz structures 
# of the most stable tautomer for the neutral species. rdkit and xyz2mol(customized) are required.
# It can be run on a csv file containing only few compounds, so not all entries are analyzed again
# (it could be slow)
...
#fake_route="/Users/luissimon/Documents/proyecto2017/pka/output_files/all/fake/"
#mv_route="/Users/luissimon/Documents/proyecto2017/pka/output_files/all/prune_auto"
...
#labels.drop(['smiles','smarts','inchi','inchiKey'],axis=1,inplace=True)
...
names_file=labels_file_name.split(".")[0]+"-extra"+".csv" 
            ...
            if len(compounds)>0:
                for mm in compounds:
                    ...
                    if cid!=None and len(synonyms)==0:
                        ...
                        #print(synonyms)
            """
        #print ("smiles:   "+str(list_of_smiles))
        #print ("smarts:   "+str(list_of_smarts))
        #print ("inchi:   "+str(list_of_inchi))

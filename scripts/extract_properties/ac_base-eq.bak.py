...
from routes import optimization_files_route
from routes import sampl_optimization_files_route
...
if "-destination" in sys.argv: destiny==sys.argv[sys.argv.index("-destination")+1]+"/"
else: destination="./"
...
routes=[output_files_route] 
print (routes)



#UNCOMMENT FOR EXTRACTING SAMPL DATA: 
routes=[sampl_output_files_route]
print (routes)
...
for compn in rows:  #cambiar
    ...
    print (protonated_molecules_file_names)
    print (deprotonated_molecules_file_names)#borrame
    print (protonated_HL_molecules_file_names)#borrame

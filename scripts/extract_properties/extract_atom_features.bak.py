...
from feature names import vector_features_publication_names
...
if graphs_extracted_file in os.listdir(): 
    print ("file for output exist; (c)ontinue or (o)verwrite?") #comment this for slurm launch
    cont=input()
    #cont="n"                                                   #uncomment this for slurm launch
    if cont=="c" or cont=="C":
...
routes=[  output_files_route+"optmization/"]
